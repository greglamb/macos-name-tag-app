...
```bash
brew tap greglamb/name-tag https://github.com/greglamb/macos-name-tag-app.git
brew install --cask greglamb/name-tag/name-tag
```
...
```bash
brew uninstall --cask greglamb/name-tag/name-tag
brew untap greglamb/name-tag
```
